          PARAMETER (NMAX=17700,KMAX=1,MMAX=KMAX*NMAX,
     .NWCMAX=3000,MWCMAX=KMAX*NWCMAX,NWDMAX=8000,
...
C  
          print *,'Entra SPARSE'
          CALL SPARSE(XCOVT,X,Y,IPX,IPY,LPX,LPY,IWD,IPUNT,JCRONA,JCOVAS,
...
75        CONTINUE 
          ...
          DO 80 L=1,IC 
          DO 80 K=1,IR 
          COVA(INR+K,L)=GASS2(DELTA,XCOVT,JJ,II,K,L,
...
122       CONTINUE 
          ENDIF
          IF(IMATRI.EQ.2) THEN 
          WRITE(12,'(i10,e24.12e4)') LC(M+1)-1,SNOISE(1)
          DO 123 I=1,LC(M+1)-1
          WRITE(12,'(i10,e24.12e4)') JC(I),C(I)
123       CONTINUE
          STOP
          ENDIF
C     
